/* THIS FILE IS GENERATED.  -*- buffer-read-only: t -*- vi:set ro:
  Original: powerpc-isa206-vsx64l.xml */

#include "defs.h"
#include "osabi.h"
#include "target-descriptions.h"

struct target_desc *tdesc_powerpc_isa206_vsx64l;
static void
initialize_tdesc_powerpc_isa206_vsx64l (void)
{
  ...
  tdesc_powerpc_isa206_vsx64l = result;
}
